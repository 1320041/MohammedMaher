...
{
    var myStr = $(this).text();alert(myStr);
    ...
    <div  class="morph-button morph-button-modal morph-button-modal-2 morph-button-fixed">
	  ...
	  <div id="student_wrap"> 	
		<table  id="students"  width="100%" >
			<tr><th>Sl No</th><th>Student Name</th><th>Address</th><th>Studied</th><th>Workplacement</th><th>Paid Per Hour<th style="padding-left:19px;">Action</th>
			</tr>
						...
						<div class="morph-content">
							<div>
								<div class="content-style-form content-style-form-1">
									...
									<form id="form1" method="post" >
										<p><label>ID</label><input type="text" id="student_id" name="student_id" value="<?php echo $data['studentid']; ?>" readonly /></p>
										<p><label>Question</label>
										<select id="questions" name="question">
										<option>If you will have more than one job on 12 January 2015, how many jobs will you have in total?</option>
										<option>What will your job title be? (If self-employed or freelance, please record this in your job title e.g. self-employed musician.</option>
										</select>
										<label>Answer</label>
										<input type="text" id="answer" name="answer" value="<?php echo $data['answer']; ?>" /></p>
										
									    <p><input  type="submit" value="Save Answers" /></p>
